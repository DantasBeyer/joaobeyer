...
const Contact = () => {
  return (
    <div cname='contact' className='w-full h-screen bg-[#0a192f] flex justify-center  items-center p-4'>
        <form method='POST'  action="https://getform.io/f/87e0d40c-6bf4-4e53-af53-d4464e682258" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4  border-[#0BD0F8]  text-gray-300'>Contac</p>
